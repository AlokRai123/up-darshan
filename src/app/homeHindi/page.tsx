...
export default function Homepage() {
  ...
  return (
    <div className="max-w-md mx-auto bg-white min-h-screen relative pb-10 border-4 border-gray-400">
      {/* Header */}
      ...
      <div className="px-4 mb-4">
        <h1 className="text-xl font-bold text-gray-800 mb-1 leading-tight">
          टैप करें और खोजें - स्कैन करें, सुनें, यात्रा करें!
        </h1>
        <p className="text-gray-600 text-sm">ऑडियो गाइड के साथ अपनी यात्रा की योजना बनाएं.</p>
      </div>
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center p-8">
            ...
            <div className="w-full h-20 bg-gradient-to-b from-blue-200/60 via-blue-300/40 to-transparent rounded-lg backdrop-blur-sm hover:bg-blue-600/20 hover:scale-105 transition-transform duration-300 relative overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <button onClick={() => router.push(slides[currentSlide].btn)}>विवरण</button> 
